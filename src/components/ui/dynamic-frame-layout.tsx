...
export interface Frame {
  id: number
  video: string // Can be a video URL or an Unsplash image URL if we change the tag
    ...
    >
      {frames.map((frame) => {
        ...
        return (
          <motion.div
            key={frame.id}
            className="relative overflow-hidden ring-1 ring-white/5 hover:ring-[#965EC7] transition-all duration-300"
            style={{
              transformOrigin,
